...
namespace SimpleDataAccessLayer_vs2013
{
	...
	//                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
	{
		...
		#region Fields
        private SimpleDataAccessLayer_vs2013Package _myPackage;
		...
		{
			pClassId = GuidList.guidSimpleDataAccessLayer_vs2013EditorFactory;
		...
		int IPersistFileFormat.Save(string pszFilename, int fRemember, uint nFormatIndex)
		{
			...
			try
			{
				_editorControl.SaveConfig(pszFilename);
